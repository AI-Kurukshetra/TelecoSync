...
import { formatDateTime, getStatusTone } from "@/lib/server/page-helpers";
...
export default async function CustomerDashboardPage() {
    ...
    return (
      ...
      >
        <SectionCard
          ...
          description="No customer context is available for this login."
        >
  ...
  const { data: services } = await supabase
    ...
    .select(
      "id, product_id, network_element_id, status, activated_at, deactivated_at, created_at",
    )
  ...
  return (
    ...
    >
      <SectionCard
        title="Service inventory"
        description="Only services linked to the signed-in customer account appear here."
      >
        <DataTable
          columns={[
            "Service",
